package com.se.ecostruxure_mmirzakhani.gui.team.update;
...
public class UpdateTeamController implements IController<Model> {
    @FXML
    ...
    private void fillFields(){
        this.teamName.setText(model.getTeam().getName());
    }
    @FXML

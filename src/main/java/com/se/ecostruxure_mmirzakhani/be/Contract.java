...
public class Contract {
    ...
    // List to hold the history of rate changes
    ...
    // Method to record a new rate and its timestamp
    public void recordHourlyRate(double rate) {
        this.hourlyRate = rate;
        hourlyRateHistory.add(rate);

...
public enum Country {
    ...
    ANDORRA("AD", "Andorra"),
    ANGOLA("AO", "Angola"),
    ANTIGUA_AND_BARBUDA("AG", "Antigua & Barbuda"),
    ...
    BHUTAN("BT", "Bhutan"),
    BOLIVIA("BO", "Bolivia"),
    BOSNIA_AND_HERZEGOVINA("BA", "Bosnia & Herzegovina"),
    ...
    RUSSIA("RU", "Russia"),
    RWANDA("RW", "Rwanda"),
    SAINT_KITTS_AND_NEVIS("KN", "Saint Kitts & Nevis"),
    SAINT_LUCIA("LC", "Saint Lucia"),
    SAINT_VINCENT_AND_THE_GRENADINES("VC", "Saint Vincent & the Grenadines"),
    SAMOA("WS", "Samoa"),
    SAN_MARINO("SM", "San Marino"),
    SAO_TOME_AND_PRINCIPE("ST", "Sao Tome & Principe"),
    ...
    TOGO("TG", "Togo"),
    TONGA("TO", "Tonga"),
    TRINIDAD_AND_TOBAGO("TT", "Trinidad & Tobago"),
    TUNISIA("TN", "Tunisia"),
    TURKEY("TR", "Turkey"),
